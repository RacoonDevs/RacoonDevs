...
const createTransporter = () => {
  const emailService = normalizeTextField(process.env.EMAIL_SERVICE).toLowerCase();
  ...
  throw new Error("EMAIL_SERVICE no valido. Usa smtp, gmail, sendgrid o console.");
};
...
const sendContactEmails = async (payload, log) => {
  ...
  if (normalizeTextField(process.env.EMAIL_SERVICE).toLowerCase() === "console") {
