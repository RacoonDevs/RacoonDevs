...
const capabilities = [
  ...
  },
  {
    ...
    description:
      "Interfaces que funcionan en cualquier pantalla. Diseno mobile-first, adaptable y validado para ofrecer usabilidad real.",
    illustration: ResponsiveIllustration,
  },
  {
    label: "eCommerce",
    icon: ShoppingCart,
    mini: "Tiendas & catalogos",
    color: "from-amber-500 to-orange-600",
    bg: "bg-amber-500/10",
    border: "border-amber-500/20",
    shadowHover: "shadow-amber-500/15",
    description:
      "Tiendas en linea con catalogos dinamicos, pasarelas de pago integradas y experiencia de compra optimizada para convertir.",
  ...
  },
  {
    ...
    description:
      "Paneles de control con graficos en tiempo real, metricas clave y reportes que ayudan a tomar decisiones rapidas.",
  ...
  },
  {
    ...
    description:
      "Conexion de APIs, webhooks y servicios de terceros. Automatizamos flujos para que tu equipo se enfoque en lo importante.",
  ...
  },
  {
    ...
    description:
      "Aplicaciones progresivas y responsive que se sienten nativas. Notificaciones push, modo offline y rendimiento optimo.",
  ...
  },
  {
    ...
    description:
      "Paginas de aterrizaje con copy estrategico, diseno orientado a accion y carga ultra-rapida para maximizar conversiones.",
          ...
          >
            {capabilities.map((item, index) => (
              ...
              >
                ...
                <motion.div
                  className={`group relative flex flex-col items-center justify-center text-center h-[120px] sm:h-[130px] p-4 rounded-xl border ${item.border} ${item.bg} hover:shadow-lg hover:${item.shadowHover} transition-all duration-500 cursor-pointer select-none`}
