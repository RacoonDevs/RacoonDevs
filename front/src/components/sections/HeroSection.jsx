...
const FloatingCard = ({
  ...
  <motion.div
    className={`absolute rounded-xl border border-white/[0.08] bg-[#0a0a0a]/80 backdrop-blur-xl shadow-2xl shadow-black/40 ${className}`}
    style={style}
...
const DashboardMockup = ({ mouseX, mouseY }) => {
  ...
  return (
    <motion.div
      className="relative w-full max-w-[520px] aspect-[16/10] rounded-xl border border-white/[0.08] bg-[#0a0a0a]/90 backdrop-blur-xl overflow-hidden shadow-2xl shadow-black/60"
      style={{ x, y }}
    ...
    >
      ...
      <div className="flex items-center gap-1.5 px-3 py-2 border-b border-white/[0.06]">
        ...
        <div className="w-2 h-2 rounded-full bg-white/10" />
        <div className="w-2 h-2 rounded-full bg-white/10" />
        <div className="ml-3 h-2 w-24 bg-white/[0.06] rounded-full" />
      </div>
      ...
      <div className="p-3 flex gap-2 h-[calc(100%-32px)]">
        ...
        <div className="w-10 flex-shrink-0 flex flex-col gap-2.5 pt-2">
          {[...Array(5)].map((_, i) => (
            <div
              key={i}
              className={`w-5 h-5 mx-auto rounded-md ${i === 0 ? "bg-white/15" : "bg-white/[0.04]"}`}
            />
          ))}
        </div>
        ...
        <div className="flex-1 flex flex-col gap-2">
          ...
          {/* Chart area */}
          <div className="flex-1 rounded-lg bg-white/[0.02] border border-white/[0.05] p-2 flex flex-col justify-between">
            <div className="flex items-center justify-between mb-1">
              <p className="text-[8px] text-gray-500">Ventas Mensuales</p>
              <div className="flex gap-2">
                <span className="text-[7px] text-gray-600">Semana</span>
                <span className="text-[7px] text-white/60 border-b border-white/20">
                  Mes
                </span>
              </div>
            </div>
            ...
            {[
              ...
              >
                <div className="flex items-center gap-1.5">
                  ...
                  <span className="text-[8px] text-gray-300">{row.name}</span>
                </div>
                <span className="text-[7px] text-gray-600">{row.time}</span>
              </motion.div>
            ))}
          </div>
        </div>
...
const MobileMockup = ({ mouseX, mouseY }) => {
  ...
  return (
    <motion.div
      className="absolute -bottom-4 -left-8 sm:-left-6 w-[110px] sm:w-[130px] aspect-[9/18] rounded-2xl border border-white/[0.1] bg-[#0a0a0a]/90 backdrop-blur-xl overflow-hidden shadow-2xl shadow-black/60 z-20"
      style={{ x, y }}
    ...
    >
      ...
      <div className="flex items-center justify-between px-2 py-1.5">
        ...
        <div className="flex gap-0.5">
          <div className="w-2 h-1.5 rounded-sm bg-white/10" />
          <div className="w-1 h-1.5 rounded-sm bg-white/10" />
        </div>
      </div>

      <div className="px-2 pt-1">
        <div className="h-1.5 w-12 bg-white/10 rounded-full mb-2" />
        <div className="h-1 w-16 bg-white/[0.06] rounded-full mb-3" />
        ...
        {[1, 2, 3].map((_, i) => (
          <div
            key={i}
            className="flex items-center gap-1.5 py-1 border-b border-white/[0.03]"
          >
            <div className="w-4 h-4 rounded-full bg-white/[0.06]" />
            <div className="flex-1">
              <div className="h-1 w-10 bg-white/[0.08] rounded-full mb-0.5" />
              <div className="h-0.5 w-14 bg-white/[0.04] rounded-full" />
            </div>
          </div>
        ))}
      </div>
      ...
      {/* Bottom nav */}
      <div className="absolute bottom-0 left-0 right-0 flex justify-around items-center py-1.5 border-t border-white/[0.06]">
        {[1, 2, 3, 4].map((_, i) => (
          <div
            key={i}
            className={`w-3 h-3 rounded-md ${i === 0 ? "bg-white/15" : "bg-white/[0.04]"}`}
          />
        ))}
      </div>
    </motion.div>
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none hidden lg:block">
        <motion.div
          ...
          style={{
            background:
              "linear-gradient(to bottom, transparent, rgba(255,255,255,0.04) 30%, rgba(255,255,255,0.04) 70%, transparent)",
          }}
          initial={{ scaleY: 0 }}
          animate={{ scaleY: 1 }}
        ...
        <motion.div
          ...
          style={{
            background:
              "linear-gradient(to right, transparent, rgba(255,255,255,0.04) 30%, rgba(255,255,255,0.04) 70%, transparent)",
          }}
          initial={{ scaleX: 0 }}
          animate={{ scaleX: 1 }}
            ...
            <div className="relative hidden lg:flex items-center justify-center">
              <div className="relative w-full max-w-[560px] aspect-[4/3]">
                ...
                >
                  ...
                  <p className="text-[11px] font-semibold text-white">+24.8%</p>
                  <p className="text-[8px] text-gray-500">Conversión mensual</p>
                ...
                >
                  ...
                  <div className="flex items-baseline gap-1">
                    <p className="text-[11px] font-semibold text-white">48</p>
                ...
                >
                  <div className="flex items-center gap-1.5 mb-1">
                    ...
                    <div>
                      ...
                      <p className="text-[7px] text-gray-500">Usuarios</p>
                    </div>
                  </div>
                </FloatingCard>
      ...
      >
        <div className="relative w-full max-w-[340px]">
          {/* Dashboard mockup */}
          <div className="w-full rounded-xl border border-white/[0.08] bg-[#0a0a0a]/80 backdrop-blur-sm overflow-hidden shadow-xl shadow-black/40">
            <div className="flex items-center gap-1 px-2.5 py-1.5 border-b border-white/[0.05]">
              <div className="w-1.5 h-1.5 rounded-full bg-white/10" />
              <div className="w-1.5 h-1.5 rounded-full bg-white/10" />
              <div className="w-1.5 h-1.5 rounded-full bg-white/10" />
              <div className="ml-1.5 h-2 w-16 bg-white/[0.04] rounded-full" />
            </div>
            <div className="p-2.5 flex gap-2">
              ...
              <div className="w-7 flex-shrink-0 flex flex-col gap-1.5 pt-1">
                {[1, 2, 3, 4].map((_, i) => (
                  <div
                    key={i}
                    className={`w-4 h-4 mx-auto rounded ${i === 0 ? "bg-white/[0.10]" : "bg-white/[0.04]"}`}
                  />
                ))}
              </div>
              {/* Main content */}
              <div className="flex-1 flex flex-col gap-1.5">
                ...
                <div className="flex gap-1.5">
                  {[
                    ...
                    <div
                      key={i}
                      className="flex-1 h-10 rounded-md bg-white/[0.04] border border-white/[0.05] p-1.5"
                    >
                      <div className="text-[5px] text-gray-500 mb-0.5">
                        {stat.label}
                      </div>
                      <div className="flex items-center gap-1">
                ...
                {/* Chart area */}
                <div className="h-16 rounded-md bg-white/[0.02] border border-white/[0.04] p-1.5">
                  <div className="flex items-center justify-between mb-1">
                    <div className="text-[5px] text-gray-500">
                      Ventas Mensuales
                    </div>
                    <div className="flex gap-1">
                      <div className="text-[4px] text-gray-600">Sem</div>
                      <div className="text-[4px] text-white/60">Mes</div>
                    </div>
                  </div>
                  <div className="flex items-end gap-0.5 h-8">
                    {[40, 65, 50, 80, 60, 75, 90, 55, 70, 85, 45, 65].map(
                      (h, i) => (
                        <div
                          key={i}
                          className={`flex-1 rounded-sm ${i === 6 ? "bg-green-400/30" : "bg-white/[0.06]"}`}
                          style={{ height: `${h}%` }}
                        />
                      ),
                    )}
                ...
                <div className="space-y-0.5">
                  {[
                    ...
                    <div
                      key={i}
                      className="flex items-center gap-1.5 px-1.5 py-0.5 rounded bg-white/[0.02]"
                    >
                      <div className={`w-1 h-1 rounded-full ${item.dot}`} />
                      <div className="text-[5px] text-gray-400 flex-1">
                        {item.name}
                      </div>
                      <div className="h-0.5 w-4 bg-white/[0.04] rounded-full" />
                    </div>
                  ))}
                </div>
              </div>
          ...
          <motion.div
            className="absolute -top-3 -right-3 p-2 rounded-lg bg-[#0d0d0d]/90 border border-white/[0.10] backdrop-blur-sm shadow-lg"
            animate={{ y: [0, -4, 0] }}
            transition={{ duration: 5, repeat: Infinity, ease: "easeInOut" }}
          >
            <div className="text-[5px] text-gray-500 mb-0.5">Analytics</div>
            <div className="flex items-center gap-1">
              <span className="text-[8px] font-bold text-white">+24.8%</span>
              <span className="text-[5px] text-green-400/70">&#9650;</span>
            </div>
            <div className="text-[4px] text-gray-600">Conversión mensual</div>
          </motion.div>

          {/* Floating card — Users (bottom left) */}
          <motion.div
            className="absolute -bottom-2 -left-2 p-2 rounded-lg bg-[#0d0d0d]/90 border border-white/[0.10] backdrop-blur-sm shadow-lg"
            animate={{ y: [0, 3, 0] }}
            transition={{
              duration: 6,
              repeat: Infinity,
          ...
          >
            <div className="flex items-center gap-1.5">
              <div className="w-4 h-4 rounded-full bg-white/[0.08] flex items-center justify-center">
                <div className="w-2 h-0.5 rounded-full bg-white/30" />
              </div>
              <div>
                <div className="text-[7px] font-semibold text-white">2.8K</div>
                <div className="text-[4px] text-gray-500">Usuarios activos</div>
              </div>
            </div>
          </motion.div>
        </div>
